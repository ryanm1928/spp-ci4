...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="font-weight-bold mb-1" style="color: var(--text-dark);">Overview SPP</h3>
    ...
    <div class="filter-wrapper mb-4">
        <form method="get" action="<?= site_url('kepala-sekolah/dashboard') ?>">
            <div class="row align-items-end">
                ...
                <div class="col-md-3 mb-2 mb-md-0">
                    ...
                    <select name="kelas_tahun_ajaran_id" id="kelas_tahun_ajaran_id" class="form-control modern-select">
                        <option value="">Semua Kelas</option>
                        <?php foreach ($kelasList as $kelas): ?>
                            <option value="<?= esc($kelas->id) ?>" <?= (int) $selectedClassId === (int) $kelas->id ? 'selected' : '' ?>>
                ...
                <div class="col-md-3 d-flex">
                    <button type="submit" class="btn flex-grow-1 mr-2 text-white" style="background-color: var(--primary-color); border:none; border-radius: 8px;">
                        <i class="fa-solid fa-filter mr-1"></i> Filter
                    </button>
                    <a href="<?= site_url('kepala-sekolah/dashboard') ?>" class="btn btn-light" style="border-radius: 8px; border: 1px solid #e2e8f0;" title="Reset Filter">
        ...
        <div class="col-md-6 col-xl-3 mb-3">
            <div class="modern-card p-3 h-100">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <p class="text-muted small font-weight-bold mb-0 uppercase">Total Siswa</p>
        ...
        <div class="col-md-6 col-xl-3 mb-3">
            <div class="modern-card p-3 h-100">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <p class="text-muted small font-weight-bold mb-0 uppercase">Pemasukan SPP</p>
        ...
        <ul class="nav nav-tabs modern-tabs mb-4" id="dashboardTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button
                    ...
                    aria-selected="true">
                    <i class="fa-solid fa-chart-column mr-2"></i> Grafik Pendapatan
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button
                    ...
                    aria-selected="false">
                    <i class="fa-solid fa-table-list mr-2"></i> Detail Siswa
                </button>
            </li>
        </ul>
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-5">
                                        <div style="color: #cbd5e1;">
                                            ...
                                            <h6 class="text-muted">Tidak ada data siswa untuk filter ini.</h6>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>

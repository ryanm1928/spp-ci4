<?php
function exportStatusLabelKepsek($status)
{
    if ($status === 'lunas') {
        return 'Sudah Bayar';
    }
...
function exportStatusMarkKepsek($status)
{
...
<head>
    <meta charset="utf-8">
    <title>Laporan SPP Kepala Sekolah</title>
</head>

<body>
    <h2>Laporan SPP Kepala Sekolah</h2>
    ...
    <table border="0" cellpadding="4">
        ...
        <tr>
            ...
            <td>:</td>
            <td><?= esc($selectedKelas['nama_kelas'] ?? 'Semua Kelas') ?></td>
        </tr>
        <tr>
                    ...
                    <?php foreach ($rows as $i => $row): ?>
                        <tr>
                            ...
                            <?php foreach ($periodeOptions as $periodeKey => $label): ?>
                                ...
                                <td align="center"><?= exportStatusMarkKepsek($cell['status']) ?></td>
                            <?php endforeach; ?>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                ...
                <?php if (!empty($rows)): ?>
                    <?php foreach ($rows as $i => $row): ?>
                        ...
                        <tr>
                            ...
                            <td><?= exportStatusLabelKepsek($row['status_pembayaran']) ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>

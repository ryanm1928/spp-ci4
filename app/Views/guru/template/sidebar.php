...
<div class="sidebar" id="sidebar">
    ...
    <ul class="nav-links">
        <li>
            <a href="<?= site_url('guru/dashboard') ?>" class="<?= $menu === 'dashboard' ? 'active' : '' ?> nav-loading-link">
        ...
        <li>
            <a href="<?= site_url('guru/spp') ?>"
                class="<?= ($menu ?? '') === 'spp' ? 'active' : '' ?> nav-loading-link">
                <i class="fa-solid fa-money-check-dollar"></i>
                <span class="link_name">Input SPP Siswa</span>
            </a>
        </li>


        <li>
            <a href="<?= site_url('guru/laporan') ?>"
                class="<?= ($menu ?? '') === 'laporan' ? 'active' : '' ?> nav-loading-link">
                <i class="fa-solid fa-file-invoice"></i>
                <span class="link_name">Laporan SPP Siswa</span>
            </a>
        </li>
